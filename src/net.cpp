...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pixicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pixicointools.com", "dnsseed.pixicointools.com"},
    {"pixicoinpool.org", "dnsseed.pixicoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"pixicointools.com", "testnet-seed.pixicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pixicoin is probably already running."), addrBind.ToString().c_str());
        else
